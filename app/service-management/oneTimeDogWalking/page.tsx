...
export default function OneTimeDogWalkingPage() {
  ...
  useEffect(() => {
    if (services.length) {
      const OneTimeDogWalkingService = services.find(service => service.serviceName === "One time Dog Walking");
      if (OneTimeDogWalkingService) {
        const fetchedCharges: ChargesFormValues = {
           FixedCharges: OneTimeDogWalkingService.fixedCharge || 0,
        ...
        ToastAtTopRight.fire({
          icon: 'error',
          title: 'Failed to fetch One Time Dog Walking service',
        });
      ...
      <ScrollArea className="h-full">
        <div className="container mx-auto p-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md mb-8">
            <h2 className="text-3xl font-bold mb-8">One Time Dog Walking</h2>
