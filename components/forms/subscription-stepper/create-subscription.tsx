    ...
    if (currentMode === 'view' && subscriptionId) {
      dispatch(getSubscriptionById(subscriptionId))
        ...
        .then((data) => {
          ...
          form.reset({ 
            userName: data.data.AssignedEmp ? data.data.AssignedEmp.Name : '',
            email: data.data.AssignedEmp ? data.data.AssignedEmp.Email : '',
            mobileNumber: data.data.AssignedEmp ? data.data.AssignedEmp.MobileNo : '',
            plan: data.data.Plan ? data.data.Plan.Name : '',
            walkFrequency: data.data.WalkFrequency,
            selectedTime: data.data.MorningTimeSlot || data.data.EveningTimeSlot || '',
            pickupLocation: data.data.PickupLocation,
            includeSundays: data.data.IncludeSundays ? 'Yes' : 'No',
